...
{
    public class KFIVString
    {
        public static string GetKFIVString(ushort[] charBuffer)
        {
            StringBuilder built = new StringBuilder();

            for (int i = 0; i < charBuffer.Length; ++i)
                built.Append(ConvChar(charBuffer[i]));

            return built.ToString();
        }

        private static string ConvChar(ushort data)
        {
            //This... Is still really fucking horrible
            switch (data)
            {
                // Fullwidth numbers
